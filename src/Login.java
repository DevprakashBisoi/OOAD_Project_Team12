...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection c1=(Connection)DriverManager.getConnection("jdbc:mysql://localhost/signin","root","manager");
        Statement s1=(Statement)c1.createStatement();
        ResultSet rs=s1.executeQuery("select*from user where Enterusername='"+u+"'");
        if(rs.next())
        {
