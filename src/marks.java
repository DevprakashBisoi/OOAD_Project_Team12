...
public class marks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("Kunstler Script", 0, 42)); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hnet.com-image.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
         ...
         s.executeUpdate("insert into marks values('"+a+"','"+c+"','"+b+"','"+m1+"','"+m2+"','"+m3+"','"+m4+"','"+m5+"')");
